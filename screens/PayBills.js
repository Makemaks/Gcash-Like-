...
class PayBills extends React.Component {
  ...
  renderArticles = () => {
    ...
    const categories = [
      { name: 'Electric Utilities', icon: 'bolt' },
      { name: 'Water Utilities', icon: 'tint' },
      { name: 'Cable Internet', icon: 'wifi' },
      { name: 'Telecoms', icon: 'phone' },
      ...
      { name: 'Health Care', icon: 'heartbeat' },
      { name: 'Schools', icon: 'graduation-cap' },
      { name: 'Payment Solution', icon: 'dollar' },
    ...
    return (
      ...
      >
        <Block flex>
          ...
          <Text style={styles.categoryTitle}>Pay Bills</Text>
